...
document.addEventListener("DOMContentLoaded", (e) =>{
  let contentWidth = document.querySelector(".articleBody")
    .getBoundingClientRect().width;

    buildGraph(contentWidth);
});

function buildGraph(contentWidth) {
  ...
  config.height = contentWidth * 0.8 - config.margin.top - config.margin.bottom;
  config.width = contentWidth  - config.margin.left - config.margin.right;
